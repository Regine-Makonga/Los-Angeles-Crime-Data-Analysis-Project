...
---
 ...
 - Create a database in MySQL Workbench, create table, load clean and prepared export from python and follow the queries in [data_analysis.sql]() then perform the analysis.
 - 
